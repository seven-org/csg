...
import org.seven.caishigou.test.domain.WechatPublicNumberShare;
 ...
 * @version
 */
public interface WechatPublicNumberShareRepository extends CustomRepository<WechatPublicNumberShare, Integer> {
