...
import org.seven.caishigou.test.domain.ShippingCapitalRecord;
 ...
 * @version
 */
public interface ShippingCapitalRecordRepository extends CustomRepository<ShippingCapitalRecord, Integer> {
