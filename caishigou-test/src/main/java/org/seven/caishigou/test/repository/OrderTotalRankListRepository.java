...
import org.seven.caishigou.test.domain.OrderTotalRankList;
 ...
 * @version
 */
public interface OrderTotalRankListRepository extends CustomRepository<OrderTotalRankList, String> {
