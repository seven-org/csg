...
import org.seven.caishigou.test.domain.WechatUserLocation;
 ...
 * @version
 */
public interface WechatUserLocationRepository extends CustomRepository<WechatUserLocation, Integer> {
