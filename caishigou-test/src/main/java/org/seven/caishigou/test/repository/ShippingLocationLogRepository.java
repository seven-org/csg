...
import org.seven.caishigou.test.domain.ShippingLocationLog;
 ...
 * @version
 */
public interface ShippingLocationLogRepository extends CustomRepository<ShippingLocationLog, Integer> {
